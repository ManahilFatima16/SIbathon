    ...
    <div className="relative flex min-h-screen bg-[#071a13] overflow-hidden font-sans text-white">
      ...
      <div className="relative flex w-full flex-col justify-center px-6 py-12 lg:w-[45%] xl:w-[40%] lg:px-16 xl:px-24 backdrop-blur-2xl bg-[#0c241a]/70 border-r border-white/10">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="h-14 w-full rounded-2xl bg-gradient-to-r from-green-500 to-emerald-600 font-bold text-white shadow-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-green-500/40 active:scale-[0.98]"
          >
            Login
          </button>
        ...
        <p className="mt-10 text-center text-sm text-white/50">
          ...
          <button className="font-bold text-green-400 hover:underline">
            Create an account
          </button>
        </p>
      </div>
